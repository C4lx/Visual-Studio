    ...
    class Game
    {
        ...
        public void Tick()
        {
            if (((Arrow == Keys.Left) && (Direction != Keys.Right)) ||
              ((Arrow == Keys.Right) && (Direction != Keys.Right)) ||
              ((Arrow == Keys.Up) && (Direction != Keys.Up)) ||
              ((Arrow == Keys.Down) && (Direction != Keys.Down)))
            {
                Direction = Arrow;
            }
            switch (Direction)
            ...
            bitmapGraph.DrawImage(Properties.Resources.food_png,(Food.Location.X *15), (Food.Location.Y * 15),15,15);
